...
// Mobile sequence — strict text/image alternation.
const mobileTiles = [
  { type: "text", title: "Hotel Exterior", desc: "Royal architecture with warm evening lights and Mithila-inspired details." },
  { type: "image", src: heroImage, alt: "The Mithila Heritage exterior at dusk" },
  { type: "text", title: "Luxury Rooms", desc: "Spacious interiors with premium comfort and crafted heritage accents." },
      ...
      {tiles.map((tile, i) =>
        tile.type === "text" ? (
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <Link to="/gallery" className="group relative block overflow-hidden aspect-square">
              <img
                src={tile.src}
                alt={tile.alt}
                loading="lazy"
    ...
    <section className="bg-cream py-20 md:py-28">
      <div className="max-w-8xl mx-auto px-6 md:px-10">
        ...
        <div className="sm:hidden">
          <PreviewGrid tiles={mobileTiles} />
        </div>
        {/* Tablet/Desktop sequence */}
        <div className="hidden sm:block">
          <PreviewGrid tiles={desktopTiles} />
        </div>
